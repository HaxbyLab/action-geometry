...
# to calculate combined regression
#
# ran ten 2025 Mar Jane
# ran nested 2024.08.29 Jane
#
# Reference code 3-2_search_RSA_reg.py
#
# How to run this code: 
# conda activate action-python2
# head1$ condor_submit ./3-3_search_RSA_reg-nested.submit
# check "CHANGE THIS PART"
...
# Supplement
ppl_rdm = np.load(join(scripts_dir, 'RDMs', 'ppl_rdm.npy')) #ppl_rdm.ipynb
# actioncat_rdm
...
## combined models
model_groups = {'twelve-transitivity': {'sociality': social_rdm,
                                     'object': static_object_rdm, 'person':static_person_rdm, 'scene': static_scene_rdm, 
                                     'verbs': verb_rdm, 'nonverbs': nonverb_rdm, 
                                     'gaze':gaze_rdm, 'motion': motion_rdm, 'people':ppl_rdm, 
                                     'category':actioncat_rdm, 'body': body_rdm},
               'twelve-sociality': {'transitivity': object_rdm, 
                                 'object': static_object_rdm,'person':static_person_rdm, 'scene': static_scene_rdm, 
                                 'verbs': verb_rdm, 'nonverbs': nonverb_rdm,
                                 'gaze':gaze_rdm, 'motion': motion_rdm, 'people':ppl_rdm,
                                 'category':actioncat_rdm, 'body': body_rdm},
               'twelve-ts': {'object': static_object_rdm,'person':static_person_rdm, 'scene': static_scene_rdm,
                          'verbs': verb_rdm, 'nonverbs': nonverb_rdm,
                          'gaze':gaze_rdm, 'motion': motion_rdm, 'people':ppl_rdm,
                          'category':actioncat_rdm, 'body': body_rdm}}

'''
model_groups = {'ten-transitivity': {'sociality': social_rdm,
                                     'object': static_object_rdm, 'person':static_person_rdm, 'scene': static_scene_rdm, 
                                     'verbs': verb_rdm, 'nonverbs': nonverb_rdm, 
                                     'gaze':gaze_rdm, 'motion': motion_rdm, 'people':ppl_rdm},
               'ten-sociality': {'transitivity': object_rdm, 
                                 'object': static_object_rdm,'person':static_person_rdm, 'scene': static_scene_rdm, 
                                 'verbs': verb_rdm, 'nonverbs': nonverb_rdm,
                                 'gaze':gaze_rdm, 'motion': motion_rdm, 'people':ppl_rdm},
               'ten-ts': {'object': static_object_rdm,'person':static_person_rdm, 'scene': static_scene_rdm,
                          'verbs': verb_rdm, 'nonverbs': nonverb_rdm,
                          'gaze':gaze_rdm, 'motion': motion_rdm, 'people':ppl_rdm}}
'''

###########################################################
model_group = 'twelve-sociality' 
#model_group = 'ten-ts' ### CHANGE THIS TO RUN DIFFERENT MODELS'
###########################################################
'''
# Dictionary of interest: verbs + nonverbs / object + person + scene/ transitivity + sociality 
model_groups = {'all-transitivity': {'sociality': social_rdm,
                                     'object': static_object_rdm, 'person':static_person_rdm, 'scene': static_scene_rdm, 
                                     'verbs': verb_rdm, 'nonverbs': nonverb_rdm, 
                                     'gaze':gaze_rdm, 'motion': motion_rdm},
               'all-sociality': {'transitivity': object_rdm, 
                                 'object': static_object_rdm,'person':static_person_rdm, 'scene': static_scene_rdm, 
                                 'verbs': verb_rdm, 'nonverbs': nonverb_rdm,
                                 'gaze':gaze_rdm, 'motion': motion_rdm},
               'all-ts': {'object': static_object_rdm,'person':static_person_rdm, 'scene': static_scene_rdm,
                          'verbs': verb_rdm, 'nonverbs': nonverb_rdm,
                          'gaze':gaze_rdm, 'motion': motion_rdm}}
###########################################################
model_group = 'all-sociality' ### CHANGE THIS TO RUN DIFFERENT MODELS'
###########################################################
'''
